...
class pool:
	...
	def reset(self):
		for key in self.COST_1:
			self.COST_1[key] = base_pool_values[0]
		for key in self.COST_2:
			self.COST_2[key] = base_pool_values[1]
		for key in self.COST_3:
			self.COST_3[key] = base_pool_values[2]
		for key in self.COST_4:
			self.COST_4[key] = base_pool_values[3]
		for key in self.COST_5:
			self.COST_5[key] = base_pool_values[4]
