...
cdef extern from "cnode.h" namespace "tree":
    cdef cppclass CNode:
        ...
        int expanded()
        float value()
        vector[float] get_q(float discount_factor);
        
        vector[int] get_trajectory()
        vector[int] get_children_distribution()
        CNode* get_child(int action)
        vector[float] get_children_value(float discount_factor)
        vector[float] get_policy(float discount_factor)
    ...
    cdef cppclass CRoots:
        ...
        vector[vector[float]] get_children_values(float discount_factor)
        vector[vector[float]] get_policies(float discount_factor)
